...
Gui Add, Button, x87 y246 w64 h24 gEXTRA, EXTRA
...
Gui 1:-Sysmenu
Gui 1:Show, w161 h311, C0MPR3SS-4-CAM
winget , hwnd,ID,C0MPR3SS-4-CAM  ; this will set hwnd to the handle of the window 
...
Gui 2:Add, Button, x12 y107 w131 h40 gSaveSettings, GOOD TO GO
Gui 2:Add, Edit, x45 y79 w67 h21 vResolution, 640x360
Gui 2:Add, Edit, x17 y29 w120 h21 vVideoFilters, fps=60
Gui 2:Add, Text, x47 y5 w65 h23 +0x200, Video Filters
Gui 2:Add, Text, x39 y54 w87 h23 +0x200, Video Resolution
Gui, 2:-Sysmenu
Gui 2:Show, w153 h159, ayy lmao
...
ffmpegvar := "ffmpeg -f dshow -framerate 15 -vcodec mjpeg -i video=""%WebCamName%"" -s %Resolution% -f nut -c:v %VCodec% %BRvar% %VQvar% -g 99999 -strict -2 -bsf noise=%GlitchAmount% -vf %VideoFilters% -  | ffmpeg -i - -f libndi_newtek -vf hflip -pix_fmt uyvy422 ShittyWebcam2.0"
...
transform, BRvar, Deref, %BRvar%
transform, VQvar, Deref, %VQvar%
ffmpegvar := "ffmpeg -f dshow -framerate 15 -vcodec mjpeg -i video=""%WebCamName%"" -s %Resolution% -f nut -c:v %VCodec% %BRvar% %VQvar% -g 99999 -strict -2 -bsf noise=%GlitchAmount% -vf %VideoFilters% udp:127.0.0.1:1337"
transform, ffmpegvar, Deref, %ffmpegvar%
...
transform, BRvar, Deref, %BRvar%
ffmpegvar := "ffmpeg -f dshow -framerate 15 -vcodec mjpeg -i video=""%WebCamName%"" -s %Resolution% -f nut -c:v %VCodec% %BRvar% -g 99999 -q:v %VQuality% -strict -2 -bsf noise=%GlitchAmount% -vf %VideoFilters% -  | ffplay -i -"
transform, ffmpegvar, Deref, %ffmpegvar%
 ;msgbox, %ffmpegvar%
